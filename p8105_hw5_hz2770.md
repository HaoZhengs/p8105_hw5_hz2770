...
```
    ...
    ##    <fct>              <dbl> <dbl>        <dbl>
    ##  1 control_group          1     1         0.2 
    ##  2 control_group          1     2        -1.31
    ##  3 control_group          1     3         0.66
    ##  4 control_group          1     4         1.96
    ##  5 control_group          1     5         0.23
    ##  6 control_group          1     6         1.09
    ##  7 control_group          1     7         0.05
    ##  8 control_group          1     8         1.94
    ##  9 control_group          2     1         1.13
    ## 10 control_group          2     2        -0.88
    ## # ... with 150 more rows
...
From the spaghetti plot, we can see that the experiment arm has an
overall increasing trend as time goes by, while the control arm has a
rather stable value with a little fluctuation.
